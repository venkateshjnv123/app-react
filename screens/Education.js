...
export default function Education({navigation}){
  ...
  const items= [
      {id:1, name:'College', title:{title: 'College', main: 'Auto-edu'}},
      {id:2, name:"School", title:{title: 'School', main: 'Auto-edu'}},
      {id:3, name:'Play school', title:{title: 'Play-school', main: 'Auto-edu'}},
      {id:4, name:'Coaching center', title:{title: 'Coaching-center', main: 'Auto-edu'}},
      {id:5, name:'Tution classes', title:{title: 'Tution-classes', main: 'Auto-edu'}},
      {id:6, name:'Dance and music', title:{title: 'Dance-music', main: 'Auto-edu'}},
      {id:7, name:'Computer center', title:{title: 'Computer-center', main: 'Auto-edu'}},
