...
export default function Travel({navigation}){
  ...
  const items= [
      {id:1, name:'Bus scedule',  title:{title: 'Bus-schedule', main: 'Service'}},
      {id:2, name:"Train schedule",  title:{title: 'Train-schedule', main: 'Service'}},
      {id:3, name:'Auto rickshaw', title:{title: 'Auto-rickshaw', main: 'Service'}},
      {id:4, name:'Taxi boking',  title:{title: 'Taxi-schedule', main: 'Service'}},

      ]
   const renderItem = ({item}) => (
    <TouchableOpacity style={Style.card} onPress={()=> navigation.navigate('Traveldetails', item.title)}>
