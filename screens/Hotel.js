...
export default function Restaurents({navigation}){

  const items= [
      {id:1, name:'Family Restaurents'},
      {id:2, name:"Hotel and lodging"},
      {id:3, name:'Fast food corner'},
      {id:4, name:'Bar'},
      {id:5, name:'Non-veg'},
      {id:6, name:'Veg restaurents'},
